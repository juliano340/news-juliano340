...
module.exports = {
  ...
  AI_EDITORIAL_MAX_TOKENS: parseNumber(process.env.AI_EDITORIAL_MAX_TOKENS, 900),
  AI_EDITORIAL_SKIP_REVIEW: parseBoolean(process.env.AI_EDITORIAL_SKIP_REVIEW, true),
