...
module.exports = {
  ...
  SOURCES: {
    ...
    GZH: { enabled: true, url: 'https://gauchazh.clicrbs.com.br/rss/ultimas/' },
    CORREIO: { enabled: true, url: 'https://www.correiodopovo.com.br/rss/ultimas/' },
    TECMUNDO: { enabled: true, url: 'https://www.tecmundo.com.br/rss.xml' },
    TRENDS: { enabled: true }
  }
};